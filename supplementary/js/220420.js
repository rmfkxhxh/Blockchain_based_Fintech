...
// // 2
// testArray.forEach(function (number, index, arr) { // forEach 인자
//   console.log("1. number : ", number, " index : ", index, " arr : ", arr);
// })

// let arrayMapped = testArray.map(x => x * 2);
// arrayMapped.forEach(function (number, index, arr) { // forEach 인자
//   console.log("map. number : ", number, " index : ", index, " arr : ", arr);
// })
